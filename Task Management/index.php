...
<head>
  <?php
    $pageTitle = "Task Management"; // Set the title for this page
...
<body>
  ...
  <header id="header">  
    ...
    <nav class="navbar" id="navbar">
      <div class="logo"><a href="index.php"></a> <span class="menu-icon" 
  ...
  <section id="hero">
    <div class="headings">
      <div class="main-heading">
        <p>Manage Tasks Smarter.</p>
        <p>Empower Teams Faster.</p>
      </div>
